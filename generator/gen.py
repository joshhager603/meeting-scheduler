...
def create_event_batch(batch_size=500):
    ...
    for _ in range(batch_size):
        ...
        participants = [generate_participant_data(meeting['meeting_id']) for _ in range(random.randint(50, 100))]
        attachments = [generate_attachment_data(meeting['meeting_id']) for _ in range(random.randint(5, 10))]
